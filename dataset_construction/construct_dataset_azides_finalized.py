...
def get_bio_dipolarophiles_list():
...
def get_synthetic_dipolarophiles_list():
    return ['C1CCCC#CCC1', 'C1=CC2CCC1C2', 'C1=CC2C=CC1O2', 'C1CCCC#CC(F)(F)C1', 'C1=C(C(F)(F)F)C2CCC1C2',
                         'C1=C(C(F)(F)F)C2C=CC1O2','C1(C(=O)NC)=C(C(F)(F)F)C2C=CC1O2', 'C1(C(=O)NC)=CC2C=CC1O2']
...
def get_r_smiles_list(azide_list, bio_dipolarophiles_list):
    r_smiles_list = []
    for dipole in azide_list:
        for dipolarophile in bio_dipolarophiles_list:
            r_smiles_list.append(f'{dipolarophile}.{dipole}')
...
if __name__ == '__main__':
    ...
    r_smiles_list1 = get_r_smiles_list(azide_list, bio_dipolarophiles_list)
    r_smiles_list2 = get_r_smiles_list(azide_list, synthetic_dipolarophiles_list)
    r_smiles_list = r_smiles_list1 + r_smiles_list2
    ...
    rxn_smiles_list = list(set(rxn_smiles_list))
    df = pd.DataFrame(rxn_smiles_list)
    df['rxn_smiles'] = df[0]
